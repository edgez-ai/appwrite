...
use Appwrite\Utopia\Response\Model\ActivityEvent;
use Appwrite\Utopia\Response\Model\AgentRun;
...
use Appwrite\Utopia\Response\Model\ChatBinding;
...
use Appwrite\Utopia\Response\Model\Evidence;
...
use Appwrite\Utopia\Response\Model\ProjectManagementCapabilities;
use Appwrite\Utopia\Response\Model\ProjectManagementContext;
use Appwrite\Utopia\Response\Model\ProjectProtocol;
use Appwrite\Utopia\Response\Model\ProjectService;
use Appwrite\Utopia\Response\Model\ProjectTask;
...
use Appwrite\Utopia\Response\Model\Sticker;
use Appwrite\Utopia\Response\Model\StickerGroup;
use Appwrite\Utopia\Response\Model\StickerGroupSummary;
use Appwrite\Utopia\Response\Model\Subscriber;
use Appwrite\Utopia\Response\Model\Table;
use Appwrite\Utopia\Response\Model\Target;
use Appwrite\Utopia\Response\Model\TaskExecutionContext;
...
Response::setModel(new BaseList('Project Tasks List', Response::MODEL_PROJECT_TASK_LIST, 'tasks', Response::MODEL_PROJECT_TASK));
Response::setModel(new BaseList('Stickers List', Response::MODEL_STICKER_LIST, 'stickers', Response::MODEL_STICKER));
Response::setModel(new BaseList('Sticker Groups List', Response::MODEL_STICKER_GROUP_LIST, 'groups', Response::MODEL_STICKER_GROUP));
Response::setModel(new BaseList('Sticker Group Summaries List', Response::MODEL_STICKER_GROUP_SUMMARY_LIST, 'summaries', Response::MODEL_STICKER_GROUP_SUMMARY));
Response::setModel(new BaseList('Agent Runs List', Response::MODEL_AGENT_RUN_LIST, 'runs', Response::MODEL_AGENT_RUN));
Response::setModel(new BaseList('Evidence List', Response::MODEL_EVIDENCE_LIST, 'evidence', Response::MODEL_EVIDENCE));
Response::setModel(new BaseList('Activity Events List', Response::MODEL_ACTIVITY_EVENT_LIST, 'events', Response::MODEL_ACTIVITY_EVENT));
Response::setModel(new BaseList('Chat Bindings List', Response::MODEL_CHAT_BINDING_LIST, 'bindings', Response::MODEL_CHAT_BINDING));
...
Response::setModel(new ProjectTask());
Response::setModel(new Sticker());
Response::setModel(new StickerGroup());
Response::setModel(new StickerGroupSummary());
Response::setModel(new AgentRun());
Response::setModel(new Evidence());
Response::setModel(new ActivityEvent());
Response::setModel(new ChatBinding());
Response::setModel(new TaskExecutionContext());
Response::setModel(new ProjectManagementCapabilities());
Response::setModel(new ProjectManagementContext());
