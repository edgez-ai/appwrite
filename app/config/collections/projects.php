...
return [
    ...
    'deviceCredentials' => [
        '$collection' => ID::custom(Database::METADATA),
        '$id' => ID::custom('deviceCredentials'),
        'name' => 'Device Credentials',
        'attributes' => [
            [
                '$id' => ID::custom('deviceInternalId'),
        ...
        'indexes' => [
            [
                '$id' => ID::custom('_unique_device'),
                'type' => Database::INDEX_UNIQUE,
                'attributes' => ['deviceInternalId'],
                'lengths' => [],
                'orders' => [Database::ORDER_ASC],
            ],
            [
                '$id' => ID::custom('_key_deviceId'),
                'type' => Database::INDEX_KEY,
                'attributes' => ['deviceId'],
                'lengths' => [Database::LENGTH_KEY],
                'orders' => [Database::ORDER_ASC],
